...
class NodeT{
    public:
        ...
        int getKey(){ return key; } //Descripción: Función que regresa el valor de key: O(1)
        void setKey(int key);
        string getIp() {return ip;} //Descripción: Función que regresa el valor de left: O(1)
        void setIp(string ip);
        NodeT *getLeft() { return left;} //Descripción: Función que regresa el valor de left: O(1)
        void setLeft(NodeT *left);
        NodeT* getRight() { return right;} //Descripción: Función que regresa el valor de right: O(1)
